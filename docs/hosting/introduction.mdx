...
<Note>
    Review the [Snapshots and Environment Lifecycle](/snapshots) docs to learn more about how we can achieve a fast cold-start and what the state of your VM is. 
</Note>