---
title: "Sharing configuration across repositories: The Layerfile Library"
sidebarTitle: "The Layerfile Library"
description: "Sharing configuration across repositories"
---

`FROM` can inherit `Layerfile` configurations from the internet.

The [Layerfile library](https://webapp.io/library) contains configurations that we've pre-created
like `FROM webapp.io/node:18`. It also lets you define your own shared
