...
<iframe src="https://drive.google.com/file/d/1dHiyZngxAZYkF7OCEIujVhjibFF81jK7/preview" width="100%" height="100%" className="tw-rounded no-href-check" allow="autoplay" />
</div>
...
#### <a href="https://github.com/joshuadsouza/webappio-docs-examples/tree/master/webappio-angular" target="_blank" className="no-href-check">View Project Source Code <NewTabIcon /></a>
