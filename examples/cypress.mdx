...
View our example repository, that embeds Cypress test results in pull requests [here](https://github.com/webappio/CypressMochawesomeExample).
...
For a detailed tutorial on setting up Cypress with webapp.io, <a href="/docs/integrations/cypress">click here.</a>