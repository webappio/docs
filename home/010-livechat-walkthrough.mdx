...
Next, try making another change to one of the views (I.e., in <code class="CodeHightlight-Inline">/services/web/src/views/login/login.js</code>) and push a new commit to see another preview environment with your changes.
