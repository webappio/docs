...
- Use `FROM webapp.io/rails:2.7.1` to inherit from the [shared Layerfile library](/library) configuration `rails:2.7.1`
- Use `FROM my-org/base:v1.0.0` to inherit from a common image for your organization in the [shared Layerfile library](/library)
